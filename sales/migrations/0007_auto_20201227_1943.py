# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2020-12-27 11:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sales', '0006_enrollment_contract_approved'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_num', models.IntegerField(help_text='填写几节课，或者是几天的课程', verbose_name='节次')),
                ...
                ('course_memo', models.TextField(blank=True, max_length=300, null=True, verbose_name='课程内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(choices=[(100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (70, 'B-'), (60, 'C+'), (50, 'C'), (40, 'C-'), (0, 'D'), (-1, 'N/A'), (-100, 'COPY'), (-1000, 'FAIL')], default=-1, verbose_name='课程成绩')),
                ('homework_note', models.CharField(blank=True, max_length=300, null=True, verbose_name='作业批语')),
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.CourseRecord', verbose_name='某个课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Custumer', verbose_name='学员')),
            ],
        ),
