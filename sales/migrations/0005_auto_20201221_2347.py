# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2020-12-21 15:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('A', '近期无报名计划'), ('B', '一个月内报名'), ('C', '2周内报名'), ('D', '1周内报名'), ('E', '订金'), ('F', '到班'), ('G', '全款'), ('H', '无效')], help_text='客户此时的状态', max_length=8, verbose_name='跟进状态')),
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Custumer', verbose_name='咨询的客户')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encroll_date', models.DateTimeField(auto_now_add=True, verbose_name='报名日期')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Custumer', verbose_name='客户名称')),
                ('enrolment_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Classlist', verbose_name='所报班级')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Campuses', verbose_name='校区')),
            ],
        ),
